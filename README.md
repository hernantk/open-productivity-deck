...
- Tela inicial do desktop com a grade do deck; configurações, áudio e pareamento em tela separada.
- Tema claro/escuro sincronizado entre desktop e PWA.
- Grade configurável em 3×3, 4×4 ou 5×5.
